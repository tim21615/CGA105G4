                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login" >
                            <h3 class="text-center mb-60">您已經成功修改密碼!</h3>
                            <h6 class="text-center mb-60">您已經成功修改密碼，請以新密碼重新登入帳號。</h6>
                            <a href="<%=request.getContextPath() %>/front_end/login.jsp" type="hidden"><button class="btn w-100">重新登入</button></a>
                        </div>
                    </div>
                </div>
            </div>
