			...
			<div class="container">
				...
				<body>
					<div class="form-wrapper">
						<h1 class="mb-4">填入募資商品選項</h1>
						<form METHOD="post" ACTION="propOpt.do" name="form1"
							enctype="multipart/form-data">
							
							<div class="input-group input-group-sm mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text" id="inputGroup-sizing-sm">商品選項名稱</span>
								</div>
								<input type="text" class="form-control" aria-label="Small"
									aria-describedby="inputGroup-sizing-sm" name="optionName">
									<div class="invalid-feedback">不可空白</div>
							</div>
							<div class="image-upload-wrapper">

								<input type="file" id="showimg" multiple name="upload" /> <label>商品選項照片</label>
								<div class='row'>
							...
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text">商品金額$</span>
								</div>
								<input type="number" class="form-control"
									aria-label="Amount (to the nearest dollar)" name="optionPrice" pattern="(/^\d+(?:\.\d{0,2})?$/)" required>
							...
							<div class="d-grid">
								<input type="submit" class="btn btn-primary" name="action" value="繼續新增"> 
								<input type="submit" class="btn btn-primary float-right" name="action" value="送出申請">
							</div>
