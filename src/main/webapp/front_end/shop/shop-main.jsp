						...
						<form
							...
							<div class="widget mb-60 " style="border: 0px;">
								...
								<c:if test="${not empty errorMsgs}">
									<div class="d-block">
										<h5 style="color: blue" class="d-inline-block">請修正以下錯誤:</h5>
										<ul class="d-inline-block">
											<c:forEach var="message" items="${errorMsgs}">
												<li class="d-inline" style="color: blue">&nbsp;${message}</li>
											</c:forEach>
										</ul>
									</div>
								</c:if>
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="home" role="tabpanel"
							...
							<div class="row">
								...
								<c:forEach var="shopProdVO"
									items="<%=new ShopProdService().getAll()%>">
										...
										<div class="col-lg-4 col-md-6">
											<div class="product mb-40">
												<div class="product__img"
													...
													<%--                                                         <a href="<%=request.getContextPath()%><%= prodDetail %>${shopProdVO.productId}"><i class="fas fa-shopping-cart"></i></a> --%>
													<%--                                                         <a href="<%=request.getContextPath()%><%= prodDetail %>${shopProdVO.productId}"><i class="fas fa-heart"></i></a> --%>
													<%--                                                         <a href="<%=request.getContextPath()%><%= prodDetail %>${shopProdVO.productId}"><i class="fas fa-expand"></i></a> --%>
													<!--                                                     </div> -->
												</div>
