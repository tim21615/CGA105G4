...
<%
	...
	String location = (request.getContextPath() + "/front_end/shop/productDetail.do?" + request.getQueryString().toString());
                                ...
                                <ul class="nav" id="myTab2" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                            aria-selected="true"><img src="data:image/jpg;base64,${shopProdVO.prodOptVO.get(0).productPictureString}" alt=""> </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                            aria-selected="false"><img src="data:image/jpg;base64,${shopProdVO.prodOptVO.get(1).productPictureString}" alt=""></a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content" id="myTabContent2">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel">
                                        <div class="product-large-img">
                                            <img src="data:image/jpg;base64,${shopProdVO.productPictureString}" alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="product-details mb-30">
                                <div class="product-details-title">
                                    ...
                                    <div class="price details-price pb-30 mb-20">
                                        ...
                                        <br>
                                        <br>
                                        	<jsp:useBean id="prodOptSvc" scope="page" class="com.prodopt.model.ProdOptService" />
                                        <ul>
                                          <li>
										       <b>商品選項:</b>
										       <select size="1" id="shopProdOpts" name="productOptionId">
                                ...
                                <div class="product-details-action">
                                    <form METHOD="post" action="<%=request.getContextPath() %>/front_end/shop/shopCartList.do">
										...
										<input type="hidden" name="action" 				  value="addOneProdToShopCartList">
                                        <input type="hidden" name="productOptionId" 	  id="shopCartProdOptId"  value="">
                                        <input type="hidden" name="memberId"			  id="shopCartMemId"	  value="${sessionScope.mem.memberId}">
                                        <input type="hidden" name="productOptionQuantity" id="shopCartProdOptQty" value="">
	                                    <c:if test="${empty mem }">
                                 			<button class="inactive-btn" id="heartBtn"><i class="fas fa-heart"></i></button>
                              			</c:if>
                                ...
                                <ul class="nav text-center justify-content-center pb-30 mb-50" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="desc-tab" data-toggle="tab" href="#id-desc" role="tab"
                                            aria-controls="home" aria-selected="true">商品描述</a>
                                    </li>
...
<!--                                         </div> -->
	...
	$(document).ready(function() {
		...
		$('#shopCartProdOptId').val($('#shopProdOpts option:selected').data('prodoptid'));
		$('#shopProdOpts').change(function() {
			let selectedOption = $('#shopProdOpts option:selected');  
            let price = selectedOption.data('prodoptprice');
            let id = selectedOption.data('prodoptid');
            $('#shopProdPrice').text(price);
            $('#shopProdOptName').text(selectedOption.text());
