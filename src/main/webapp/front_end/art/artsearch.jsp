			...
			<div class="container">
				...
				<main>
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">搜尋文章結果</li>
					</ol>
							...
							<div class="row">
								<div class="col-lg-8">
									<article class="postbox post format-image mb-40">
										<div class="postbox__thumb"></div>
										<div class="mb-10">
											<div class="postbox__text p-10">
												<c:forEach var="artVO" items="${artList}">
													<div calss="article" my-5>
														<br>
														<br>
														<br>
														<div class="post-meta my-1" grid-column-gap: 20px>
															<br> <span><i class="far fa-calendar-check"></i>${artVO.articlePostTime}</span>
														</div>
														<h3 class="blog-title">
