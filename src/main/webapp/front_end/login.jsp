                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login">
                            <h3 class="text-center mb-60">會員登入</h3>
                            <form method="post" action="<%=request.getContextPath() %>/front_end/log.do">
                                <label for="name">會員帳號 </label><div style="color: red">${requestScope.loginAccount_error}</div>
                                <input id="name" type="text" name="memberAccount" value="${param.memberAccount}" placeholder="請輸入帳號" required/>
                                <label for="pass">會員密碼 </label><div style="color:red">${requestScope.loginPassword_error}</div>
                                <input id="pass" type="password" name="memberPassword" value="${param.memberPassword}" placeholder="請輸入密碼" required/>
                                <div class="login-action mb-20 fix">
                                    <span class="forgot-login f-right">
                                        <a href="<%=request.getContextPath()%>/front_end/mem/find_password01.jsp">忘記密碼</a>
                                    </span>
                                </div>
                                <input type="hidden" name="action" value="login">
                                <button class="btn btn-black w-100">登 入</button>
                           </form>
                                <div class="or-divide"><span>or</span></div>
                                <a href="<%=request.getContextPath()%>/front_end/register.jsp"><button class="btn w-100">還沒註冊嗎?</button></a>
