		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">
						您正在編輯 <span style="color: blue;">${memVO.memberName}</span> 的帳號狀態。
					</h1>
					<div class="container">
						<div class="row align-items-end">
							<table class="table">
								<tr>
									<td align="right"><a
										href="<%=request.getContextPath()%>/back_end/mem/member_list.jsp"
					...
					<div class="card mb-4">
						<table class="table table-hover">
							<form method="post"
								action="<%=request.getContextPath()%>/back_end/mem/member.do">
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="onoffswitch">
												<input type="checkbox" name="status" value="1"
													...
													tabindex="0" ${(memVO.memberStatus == 1)? 'checked' : '' }>
										...
										<td align="right"><input type="hidden" name="memberId"
											value="${memVO.memberId}"> <input type="hidden"
											name="action" value="save_status">
											<button type="submit" class="btn btn-warning">保存</button></td>
