        ...
        <div class="row">
            <div class="col-sm-12">
                <form id="form1" class="md-float-material form-material" action="<%=request.getContextPath() %>/back_end/admin/admin.do" method="POST">
					<input type="hidden" name="action" value="edite_personal_name">
					<input type="hidden" name="adminId" value="${sessionScope.admin.adminId}">
                    <div class="auth-box card">
                        <div class="card-block">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="text-center heading" >您正在修改自己的名稱。</h3>
                            ...
                            <div class="form-group form-primary">
                            	<div style="color:red">${requestScope.adminAccountName_error}</div>
                                <input type="text" class="form-control" name="adminAccountName" value="${param.adminAccountName}" placeholder="請輸入新的名稱" >
