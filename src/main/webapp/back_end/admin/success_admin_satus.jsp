		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">已經將 <span style="color: blue;">${adminVO.adminAccountName}</span> 的帳號狀態編輯成功!</h1>
					<div class="container">
						<div class="row align-items-end">
							<table class="table">
								<td>以下為 <span style="color: blue;">${adminVO.adminAccountName}</span> 的帳號狀態。</td>
								
								<td align="right"><a	href="<%=request.getContextPath()%>/back_end/admin/admin_list.jsp"
