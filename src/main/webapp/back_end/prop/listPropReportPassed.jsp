...
List<PropReportVO> filteredList = list.stream().filter(propReportVO -> propReportVO.getReportStatus() == Status.未通過 || propReportVO.getReportStatus() == Status.通過)
							...
							<tbody>
								...
								<c:forEach var="propReportVO" items="${filteredList}"
									...
									<tr>
										...
										<td>${propReportVO.reportResult}</td>

									<td>${propReportVO.reportStatus}</td>
								</c:forEach>
