...
public class ShopServlet_mumu extends HttpServlet{
			...
			req.setAttribute("errorMsgs", errorMsgs);
				...
				if (!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req
							.getRequestDispatcher("/front_end/shop/select_page.jsp");
				...
				String url = "/front_end/shop/shop-product-details.jsp";
